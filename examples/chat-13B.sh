...
MODEL="${MODEL:-/home/xun/mlmodels/Wizard-Vicuna-13B-Uncensored.ggmlv3.q5_1.bin}"
PROMPT_TEMPLATE=${PROMPT_TEMPLATE:-./prompts/chat-with-vicuna-v1.txt}
USER_NAME="${USER_NAME:-USER}"
AI_NAME="${AI_NAME:-homebot}"
